...
class ExampleGame {
    ...
    public Scene init (int width, int height) {
        ...
        myButton = new Button("Change Direction!");
        myButton.setOnAction(e -> handleDirectionButtonTap());
    ...
    public void step (double elapsedTime) {
        // update attributes
    	if (myBouncer.getX() + myBouncer.getLayoutBounds().getWidth() >= myScene.getWidth()){
    		goRight = false;
    ...
    private void handleDirectionButtonTap(){
    	goRight = !goRight;
    }
